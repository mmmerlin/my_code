...
#     key_list.append('ions_per_frame')
    ...
    ID_list = ['410','415','418','420','421','422','423','424','425','426','427','428','429','430']
    ...
    for key in key_list:
        ...
        legend = TLegend(0.7,0.6,0.99,0.99) #position the legend at top left
        for i, ID in enumerate(ID_list):
            print (i/9)
            object_list[ID + key].SetLineColor(1 + (i%9))
            object_list[ID + key].SetFillColor(1 + (i%9))
            object_list[ID + key].SetFillStyle(3008 - (i/9)*(2143))
