...
conversion_in  = '/mnt/hgfs/VMShared/Data/oxford/june_2015/Day4/pimms/run1/'
conversion_out = '/mnt/hgfs/VMShared/Data/oxford/june_2015/Day4/pimms_to_timepix/run1/'
